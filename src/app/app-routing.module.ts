...
const routes: Routes = [
  {path: '', canActivate:[authGuard],
    ...
    children:[
      ...
      {path:'forgotpassword',loadComponent:()=>import('./components/forgotpassword/forgotpassword.component').then((m)=>m.ForgotpasswordComponent),title:'Reset Password'},
  ...
  {path:'',
    ...
    children:[
      ...
      {path:'forgot',loadComponent:()=>import('./components/forgotpassword/forgotpassword.component').then((m)=>m.ForgotpasswordComponent),title:'Reset Password'},
    ]
